                ...
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span
                        className={`inline-flex items-center rounded border px-2 py-0.5 text-xs font-medium ${COR_BADGE[p.cor] ?? COR_BADGE.blue}`}
                      >
                        Nível {p.nivel}
                      </span>
                    </div>
                    {p.descricao && (
                      <p className="text-muted-foreground truncate text-xs">{p.descricao}</p>
                    )}
                  </div>
                </div>
                <Button
